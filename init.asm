...
;	.line	58; "init.c"	OPTION = 0x00;	//下降沿中断 Fcpu 上升沿计数 TMR0 1/2预分频
	CLRF	_OPTION
...
;	.line	59; "init.c"	PCON |= 0x90; 	//使能WDT
	MOVLW	0x90
	IORWF	_PCON,F
...
;	.line	61; "init.c"	CMPCR = 0x00;  //关闭比较器
	CLRF	_CMPCR
...
;	.line	46; "init.c"	PORT_LED1 = 1;  //灯光  1：灭  0：亮
	BSF	_PORTBbits,1
...
;	.line	47; "init.c"	PORT_LED2 = 1;  //电机 1：灭  0：亮
	BSF	_PORTBbits,0
